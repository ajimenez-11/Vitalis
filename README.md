...
- **Autenticació i Rols:** Sistema de rols diferenciat (administrador, responsable de cuina, cuiner) amb tokens via Laravel Sanctum.
...
## 📖 Documentació
- [Guia de desenvolupament](docs/documentacio-vitalis.md) — Tecnologies, estructura del projecte, model de dades i API REST.
